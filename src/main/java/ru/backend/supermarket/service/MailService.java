...
public class MailService {
    private static final String APPLICATION_NAME = "SuperMarket";
    private static final JsonFactory JSON_FACTORY = JacksonFactory.getDefaultInstance();
    private static final String TOKEN_DIRECTORY_PATH = "tokens";

    private static final List<String> SCOPES = ImmutableList.of(GmailScopes.GMAIL_SEND, GmailScopes.MAIL_GOOGLE_COM);
    ...
    private Credential getCredentials(final NetHttpTransport httpTransport) throws IOException {
        ...
        if (in == null) {
            throw new FileNotFoundException("Файл с данными о пользователе не найден");
        }
